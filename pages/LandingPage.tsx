...
export const LandingPage: React.FC = () => {
  ...
  const defaultConfig: LandingPageConfig = {
    ...
    hero_title: 'ABCUNA',
    hero_subtitle:
      'Excelência e compromisso em salvar vidas e servir a comunidade.',
    hero_badge_text: 'Desde 2020',
    hero_image_url: '',
    about_title: 'Nossa Essência',
    about_text:
      'A ABCUNA é referência especializada em atendimento de emergência. A nossa equipe de elite combina técnica apurada e humanização para agir nos momentos mais críticos, garantindo segurança e suporte vital quando você mais precisa.',
    ...
    services: [
      {
        title: 'Atendimento APH',
        description: 'Suporte avançado de vida 24h com UTIs móveis equipadas.',
        icon: 'activity',
      },
      {
        title: 'Formação',
        description:
          'Cursos técnicos certificadores para profissionais e leigos.',
        icon: 'award',
      },
      {
        title: 'Eventos',
        description:
          'Cobertura médica completa e segurança para grandes eventos.',
        icon: 'calendar',
      },
      {
        title: 'Consultoria',
        description: 'Gestão de riscos, planos de emergência e auditorias.',
        icon: 'briefcase',
      },
    ],
    testimonials: [],
          ...
          <div className="h-full flex flex-col animate-fadeIn">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 overflow-y-auto pr-2 pb-4 scrollbar-hide h-full content-start">
              {displayConfig.services?.map((service, idx) => (
                <div
                  key={idx}
                  className="group p-5 bg-white border border-slate-100 rounded-xl shadow-sm hover:shadow-md hover:border-red-100 transition-all"
                >
        ...
        return (
          <div className="h-full flex flex-col animate-fadeIn">
            ...
            <div className="mt-auto pt-4 border-t border-slate-100">
              <p className="text-xs font-semibold text-slate-600 mb-4 uppercase tracking-wider">
                Redes Sociais
              </p>
              <div className="flex gap-3">
                {displayConfig.social?.facebook && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex-1 py-3 bg-[#1877F2] text-white rounded-lg flex items-center justify-center gap-2 hover:opacity-90 transition-opacity shadow-sm"
                  >
                    <Facebook size={18} />{' '}
                ...
                {displayConfig.social?.instagram && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex-1 py-3 bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white rounded-lg flex items-center justify-center gap-2 hover:opacity-90 transition-opacity shadow-sm"
                  >
                    <Instagram size={18} />{' '}
            ...
            <div className="flex-1 flex flex-col lg:h-full overflow-y-auto pr-4 scrollbar-hide py-2">
              ...
              <div className="flex flex-col mt-auto pt-4">
                ...
                <div className="w-full rounded-2xl shadow-xl overflow-hidden bg-slate-50 relative shrink-0">
                  <LandingPageCarousel
                    images={displayConfig.gallery_images || []}
                  />
                </div>
              </div>
            </div>
  ...
  return (
    ...
    <div
      className={`min-h-screen lg:h-screen w-full bg-[#0f172a] text-slate-900 flex items-center justify-center p-0 sm:p-4 lg:p-8 overflow-y-auto lg:overflow-hidden font-sans transition-all duration-700 ease-in-out transform ${isExiting ? 'opacity-0 scale-95 blur-sm' : 'opacity-100 scale-100'}`}
    >
