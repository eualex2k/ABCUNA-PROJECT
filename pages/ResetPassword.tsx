  ...
  useEffect(() => {
    const checkSession = async (attempt = 1) => {
      ...
      if (session) {
        ...
        setError(
          'Sessão de segurança não encontrada. Certifique-se de clicar no link mais recente enviado ao seu e-mail.'
        );
      }
    };
        ...
        <Card className="max-w-md w-full p-8 text-center space-y-6 animate-in zoom-in-95 duration-500">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500 font-medium">
              Sua nova senha foi salva com sucesso. Você será redirecionado para
