...
import { PieChart, Download, Users, ChevronLeft, Calendar, Wallet, BellRing, CheckCircle2, AlertTriangle, X, CreditCard, Filter, Send, Edit3, Plus, RotateCcw, ArrowUpRight, Shield, Trash2, Clock, FileText, ChevronRight, Info, TrendingUp } from 'lucide-react';
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {canEdit && (
            <Button variant="outline" onClick={() => setIsFeesManagerOpen(true)} className="flex items-center gap-2">
      ...
      >
        <div className="p-6 text-center">
          <p className="text-slate-600 mb-4">Formulário de movimentação será implementado</p>
      ...
      <Modal isOpen={isFeesManagerOpen} onClose={() => setIsFeesManagerOpen(false)} title="Gestão de Mensalidades" maxWidth="4xl">
        <div className="p-6 text-center">
          <p className="text-slate-600 mb-4">Gestão de mensalidades será implementada</p>
          <Button onClick={() => setIsFeesManagerOpen(false)}>Fechar</Button>
        </div>
      </Modal>

      <Modal isOpen={isRegistrationManagerOpen} onClose={() => { setIsRegistrationManagerOpen(false); }} title="Controle de Inscrições" maxWidth="5xl">
        <RegistrationBoard
          registrations={[]}
