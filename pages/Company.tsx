      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm">
            Gerencie a identidade, registros fiscais e contatos oficiais da
            corporação.
          </p>
        </div>
          ...
          <div className="flex-1 space-y-4 text-center md:text-left">
            <div>
              ...
              <p className="text-sm text-slate-500 font-medium">
                {info.corporateName || 'Razão Social não informada'}
              </p>
            </div>
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <Card className="p-8 space-y-6 border-slate-200/60 shadow-xl shadow-slate-200/10">
            ...
            <Input
              ...
              onChange={(e) =>
                setInfo({ ...info, corporateName: e.target.value })
              }
              disabled={!isAdmin}
              required
            />
          ...
          <Card className="p-8 space-y-6 border-slate-200/60 shadow-xl shadow-slate-200/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Input
                ...
                value={info.state}
                onChange={(e) =>
                  setInfo({ ...info, state: e.target.value.toUpperCase() })
                }
                disabled={!isAdmin}
              />
            </div>
        ...
        {!isAdmin && (
          <div className="md:col-span-2 bg-slate-50 p-6 rounded-3xl border border-slate-100 flex items-center gap-4 text-slate-500 italic text-sm justify-center">
            <ShieldCheck size={20} /> Acesso restrito. Somente administradores
            podem modificar estes registros.
          </div>
        )}
      </form>
    </div>
