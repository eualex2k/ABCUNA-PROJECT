...
const envSchema = z.object({
  ...
  SUPABASE_URL: z
    .string({
      required_error:
        'A variável SUPABASE_URL é obrigatória para a integração com o banco de dados.',
    })
    .url('A variável SUPABASE_URL precisa ser uma URL válida.'),
  SUPABASE_SERVICE_ROLE_KEY: z
    .string({
      required_error:
        'A chave SUPABASE_SERVICE_ROLE_KEY é obrigatória para operações seguras no backend.',
    })
