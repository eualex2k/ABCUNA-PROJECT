...
export const MOCK_TRANSACTIONS: Transaction[] = [
  ...
  {
    id: '3',
    description: 'Manutenção Viatura 01',
    amount: 1200.0,
    type: 'EXPENSE',
    date: '2024-05-05',
    status: 'PENDING',
...
export const FINANCIAL_METRICS: FinancialMetric[] = [
  ...
  },
  {
    ...
    value: 'R$ 1.650,00',
    trend: -2,
    trendLabel: 'Dentro do orçamento',
    icon: 'check',
  },
  {
